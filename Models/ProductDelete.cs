...
public partial class cityfmcodetests {
    ...
    /// productDelete
    /// </summary>
    public static ProductDelete productDelete
    {
        get => HttpData.Get<ProductDelete>("productDelete")!;
        set => HttpData["productDelete"] = value;
    }

    /// <summary>
    /// Page class for product
    /// </summary>
    public class ProductDelete : ProductDeleteBase
    {
        // Constructor
        public ProductDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ProductDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ProductDeleteBase : Product
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "productDelete";
        ...
        // Page name
        public string PageName => "productdelete";
        ...
        // Constructor
        public ProductDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("productlist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("productlist"); // Return to list
                }
            }
